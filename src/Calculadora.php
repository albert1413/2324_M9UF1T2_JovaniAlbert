...
<div class="container mt-5">
    ...
    <div class="calculator border rounded p-4 bg-light">
        <form id="calculator" action="" method="post">
            ...
            <div id="buttons" class="d-grid gap-2">
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn btn-primary" onclick="addToInput('1')">1</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-primary" onclick="addToInput('2')">2</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-primary" onclick="addToInput('3')">3</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-secondary" onclick="addToInput('+')">+</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn btn-primary" onclick="addToInput('4')">4</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-primary" onclick="addToInput('5')">5</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-primary" onclick="addToInput('6')">6</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-secondary" onclick="addToInput('-')">-</button>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn btn-primary" onclick="addToInput('7')">7</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-primary" onclick="addToInput('8')">8</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-primary" onclick="addToInput('9')">9</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-secondary" onclick="addToInput('*')">*</button>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <button type="button" class="btn btn-primary" onclick="addToInput('0')">0</button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-secondary" onclick="addToInput('!')">!</button>
                    </div>
    ...
    <div class="history mt-4">
        <form method="post" class="mb-3">
            <input type="submit" name="logout" class="btn btn-danger" value="Tancar sessió">
        </form>
