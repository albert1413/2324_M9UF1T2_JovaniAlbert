            ...
            <form id="calculator" action="" method="post">
                ...
                <div class="d-grid gap-2">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-3"><button type="button" class="btn btn-warning" onclick="addToInput('/')">/</button></div>
                        <div class="col-3"><button type="button" class="btn btn-danger" onclick="addToInput('!')">!</button></div>
                        <div class="col-3"><button type="submit" class="btn btn-success">=</button></div>
                    </div>
                </div>
        ...
        <div class="col-12">
            ...
            <ul>
                ...
                if (isset($_SESSION['historial']) && count($_SESSION['historial']) > 0) {
                    // Invertir l'ordre de l'historial per a mostrar les operacions mes recentes primer
